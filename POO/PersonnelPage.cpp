...
POO::PersonnelPage::PersonnelPage(void)
{
	...
	//----------------------- Fin initialisation composants----------------
	//----------------------- Début initialisation tabControl1----------------
	...
	//----------------------- Fin initialisation tabControl1----------------
	//----------------------- Bouton retour----------------
	
	this->button5->Location = System::Drawing::Point(700, 0);
	...
	this->dataGridView1->Size = System::Drawing::Size(this->Width - 50, this->Height - 100);
	...
	//----------------------- Fin initialisation tabPage2----------------
	//----------------------- Formulaire Ajouter personnel page2--------------
	...
	//------------------Fin formulaire ajouter personnel------------------
	//------------------Initialisation tabpage3------------------
	...
	//------------------Fin initialisation tabpage3------------------
	//------------------Initialisation formulaire modifier------------------
	...
	//------------------Fin initialisation tabpage 4 ------------------
	//------------------Initialisation formulaire supprimer ------------------
